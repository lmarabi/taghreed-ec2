...
public class Twokenize {
    ...
    static String urlStart2 = "\\b(?:[\u0621-\u063A\u0641-\u064A\u0660-\u0669A-Za-z\\d-])+(?:\\.[\u0621-\u063A\u0641-\u064A\u0660-\u0669A-Za-z0-9]+){0,3}\\." + "(?:" + commonTLDs + "|" + ccTLDs + ")" + "(?:\\." + ccTLDs + ")?(?=\\W|$)";
    ...
    static String aa1 = "(?:[\u0621-\u063A\u0641-\u064A\u0660-\u0669A-Za-z]\\.){2,}(?=" + boundaryNotDot + ")";
    static String aa2 = "[^\u0621-\u063A\u0641-\u064A\u0660-\u0669A-Za-z](?:[\u0621-\u063A\u0641-\u064A\u0660-\u0669A-Za-z]\\.){1,}[\u0621-\u063A\u0641-\u064A\u0660-\u0669A-Za-z](?=" + boundaryNotDot + ")";
    ...
    static String wink = "[;]";
    static String noseArea = "(?:|-|[^\u0621-\u063A\u0641-\u064A\u0660-\u0669a-zA-Z0-9 ])"; // doesn't get :'-(
    ...
    static String eeSymbol = "[^\u0621-\u063A\u0641-\u064A\u0660-\u0669A-Za-z0-9\\s\\(\\)\\*:=-]";
    ...
    static String Hashtag = "#[\u0621-\u063A\u0641-\u064A\u0660-\u0669a-zA-Z0-9_]+"; //optional: lookbehind for \b
    //optional: lookbehind for \b, max length 15
    static String AtMention = "[@＠][\u0621-\u063A\u0641-\u064A\u0660-\u0669a-zA-Z0-9_]+";

    // I was worried this would conflict with at-mentions
    // but seems ok in sample of 5800: 7 changes all email fixes
    // http://www.regular-expressions.info/email.html
    static String Bound = "(?:\\W|^|$)";
    public static String Email = "(?<=" + Bound + ")[\u0621-\u063A\u0641-\u064A\u0660-\u0669a-zA-Z0-9._%+-]+@[\u0621-\u063A\u0641-\u064A\u0660-\u0669a-zA-Z0-9.-]+\\.[\u0621-\u063A\u0641-\u064A\u0660-\u0669a-zA-Z]{2,4}(?=" + Bound + ")";
    ...
    static String notEdgePunct = "[\u0621-\u063A\u0641-\u064A\u0660-\u0669a-zA-Z0-9]"; // content characters
