...
public class Lookup {
     ...
     */
    public Map<String, String> getTweetsDayIndex(String startDate, String endDate)
            throws ParseException {
...
//                    System.out.println("Month found"+(start.getMonth()+1));
     ...
     * @throws ParseException
     */
    public Map<String, String> getTweetMissingDaysinWeek(String startDate, String endDate) throws ParseException {
        Map<String, String> result = new HashMap<String, String>();
        Date start = dateFormat.parse(startDate);
        Date end = dateFormat.parse(endDate);
        ...
        while (!start.after(end)) {
            ...
            if (!cover) {
                if (days.get(start) != null) {
                    result.put(dateFormat.format(start), days.get(dateFormat.format(start)));
                }
            } else {
                cover = false;
            }
    ...
    public static boolean insideWeekBoundry(String start, String end, Week range) throws ParseException {
