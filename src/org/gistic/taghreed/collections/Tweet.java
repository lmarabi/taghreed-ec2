...
public class Tweet {
	...
	public Tweet(String created_at, String tweetID, String userID,
			String screenName, String tweetText, int followersCount, String language,
                        String osystem, String lat, String lon ) {
        ...
        public Tweet(String created_at, String tweet_id, String user_id, String screen_name, String tweet_text, String latitude, String longitude, int follower_count) {
        this.created_at = created_at;
